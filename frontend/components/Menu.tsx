        ...
        <div key={item.title} className='flex flex-col gap-2'>
          ...
          {item.items.map(subItem => {
            if(subItem.visible.includes(role)){
              return (
            <Link href={subItem.href} key={subItem.label} className='flex items-center justify-center lg:justify-start gap-4 text-gray-500 py-2 md:px-2 rounded-md hover:bg-sky-light-custom'>
